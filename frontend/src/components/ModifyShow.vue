            ...
            <form @submit.prevent="submitForm">
                <div class="row mt-3 ms-4">
                    <div class="row ms-3 mb-1">
                        ...
                        <div class="col-sm-10">
                            <input v-model="id" type="text" name="id" class="form-control w-50" disabled />
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        <div class="col-sm-10">
                            <button class="btn btn-dark" type="submit">Modify Show</button>
                        </div>
                    </div>
                </div>
            </form>
...
export default {
    ...
    created() {
        fetch('http://127.0.0.1:5000/admin/dashboard/shows/' + this.$route.params.id + '/modify', {
            method: 'GET',
            headers: {
    ...
    methods: {
        async submitForm() {
            const response = await fetch('http://127.0.0.1:5000/admin/dashboard/shows/' + this.$route.params.id + '/modify', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                this.$router.push('/admin/dashboard/shows')
            }
        }
    }
}
