<template>
    <div>
        <div class="fs-2 fw-semibold mt-2" align="center">Login</div>
        <div class="container-md border border-dark ms-10 mt-3 mb-3">
            <div align="center" v-show="incorrectCredentials">
                <div class="alert alert-danger d-flex align-items-center mt-3 w-75" role="alert">
                    ...
                    <div class="ps-2"><strong>Bad Credentials. Please login again.</strong></div>
                </div>
            </div>
            <form @submit.prevent="submitForm">
                <div class="m-4 row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" name="email" class="form-control w-50" v-model="email"
                ...
                <div class="m-4 row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="password" class="form-control w-50" v-model="password"
            ...
            <div class="m-3" align="center">
                <p>Don't have an account? <RouterLink to="/user/create" class="link-underline-light">Sign Up</RouterLink>
                </p>
            </div>
        </div>
        <div class="" align="center">
            <RouterLink to="/admin/login" class="link-underline-opacity-0 link-dark">
                <p class="fs-5 fw-medium bs-dark-text-emphasis me-3"> Login as Admin </p>
            </RouterLink>
        </div>
    </div>
</template>
